      ...
      <StyledNavigation>
        <ul>
          <StyledLink
            ...
            className={
              currentPage === "login" ? "highlightedIcon" : "normalIcon"
            }
            href={"/"}
          >
            <svg
            ...
            >
              <path
                ...
                fill={currentPage === "login" ? "#12263A" : "#FBF5F3"}
              />
            </svg>
          </StyledLink>
          ...
          <StyledLink
            ...
            href={"/home"}
            className={
              currentPage === "home" ? "highlightedIcon" : "normalIcon"
            }
          >
            <svg
              width="62"
            ...
            >
              <path
                ...
                // currentPage Indicator
                fill={currentPage === "home" ? "#12263A" : "#FBF5F3"}
              />
            </svg>
          </StyledLink>
          ...
          <StyledLink
            ...
            href={"/reward"}
            className={
              currentPage === "reward" ? "highlightedIcon" : "normalIcon"
            }
          >
            <svg
              width="62"
            ...
            >
              <path
                ...
                // currentPage Indicator
                fill={currentPage === "reward" ? "#12263A" : "#FBF5F3"}
              />
            </svg>
          </StyledLink>
        </ul>
